...
```
Changelog:
- June 25, 2025. COMPLETED: Criptografia de senhas implementada - corrigido problema de senhas em texto plano no banco de dados, implementado hash bcrypt com salt 12 nas funções createAdmin e updateAdmin, aplicado script de migração para criptografar senhas existentes (admin e gilliard), todas as senhas agora são salvas com hash $2b$12$ para máxima segurança
