...
- June 30, 2025. IMPROVED: AI context retention - enhanced system prompt to prevent AI from asking for information already provided in conversation (like service selection), added explicit context analysis instructions and critical rules to maintain conversation state
