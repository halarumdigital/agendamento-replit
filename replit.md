...
- June 21, 2025. ONGOING: Evolution API webhook configuration challenge - webhookByEvents and webhookBase64 parameters consistently return false despite being sent as true in payload, investigating proper payload structure for Evolution API v2.3.0
