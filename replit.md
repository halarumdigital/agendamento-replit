...
```
Changelog:
- June 30, 2025. IN PROGRESS: Correção sequência pagamento - implementando interceptação para que após "SIM/OK" sistema envie APENAS link de pagamento sem mensagem de confirmação da IA, confirmação final deve vir APENAS após webhook Mercado Pago aprovado, lógica de interceptação adicionada mas precisa ajustes para detectar contexto correto de resumo de agendamento
